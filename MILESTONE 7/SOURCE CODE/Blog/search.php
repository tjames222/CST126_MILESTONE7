...
?>
    ...
    ?>
		...
		<a class="button" href="homePage.php">Back to Home Page</a>&nbsp;&nbsp;<a class="button" href="readPosts.php">See All Posts</a><br><br>
		</div>
    ...
    $results = "SELECT * FROM blogpost WHERE BLOG_TITLE LIKE '%$search%' OR BLOG_TEXT LIKE '%$search%'";
    $captured = $conn->query($results);
